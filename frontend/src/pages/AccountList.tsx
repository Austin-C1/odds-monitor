...
import type { Account, AccountImportFormValues, AccountNameFormValues, AccountUpdateRequest } from '../types'
...
import AccountBuilderConfigCard from '../components/AccountBuilderConfigCard'
...
const AccountList: React.FC = () => {
  ...
  const [editForm] = Form.useForm<AccountNameFormValues>()
  const [editLoading, setEditLoading] = useState(false)
  const [accountImportModalVisible, setAccountImportModalVisible] = useState(false)
  const [accountImportForm] = Form.useForm<AccountImportFormValues>()
  ...
  const handleEditSubmit = async (values: AccountNameFormValues) => {
      ...
      <Card style={{
        ...
        {isMobile ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ padding: '0 12px 12px' }}>
                      <AccountBuilderConfigCard account={account} compact />
                    </div>
                  </Card>
                )
              }}
          ...
          <Table
            ...
            loading={loading}
            expandable={{
              expandedRowRender: (record) => <AccountBuilderConfigCard account={record} compact />
            }}
            pagination={{
              pageSize: 20,
