...
import type { CopyTradingTemplate, TemplateFormValues } from '../types'
...
const TemplateList: React.FC = () => {
  ...
  const [copyForm] = Form.useForm<TemplateFormValues>()
  ...
  const handleCopySubmit = async (values: TemplateFormValues) => {
